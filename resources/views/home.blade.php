...
@section('description', 'TEI Tarlac Electric Inc. — Your trusted power distribution company serving the province of Tarlac for over 50 years.')
...
<section class="relative min-h-screen flex items-center overflow-hidden"
    ...
    <div class="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-36 lg:py-0">
        <div class="max-w-3xl">
            ...
            {{-- Trust badge --}}
            <div id="hero-tag"
                 class="inline-flex items-center gap-2 px-4 py-1.5 rounded-full mb-8 border"
                 style="background: rgba(231,103,39,0.12); border-color: rgba(231,103,39,0.3);">
                <span class="w-2 h-2 rounded-full" style="background-color: var(--color-tei-orange); animation: pulse-glow 2.5s ease-in-out infinite;"></span>
                <span class="text-xs font-bold tracking-[0.15em] uppercase"
                      style="color: var(--color-tei-orange);">Trusted Utility Provider Since 1962</span>
            </div>

            {{-- Headline --}}
            <h1 id="hero-title"
                class="text-5xl sm:text-6xl lg:text-7xl font-black leading-[1.04] mb-6"
            ...
            {{-- Sub --}}
            <p id="hero-sub"
               class="text-lg sm:text-xl leading-relaxed mb-10 max-w-xl"
    ...
    <div class="absolute right-0 inset-y-0 w-2/5 hidden lg:block pointer-events-none overflow-hidden">
        <svg class="w-full h-full opacity-[0.06]" viewBox="0 0 400 600" fill="none" xmlns="http://www.w3.org/2000/svg">
            <path d="M200 40 L155 180 L220 180 L185 320 L250 320 L215 460" stroke="white" stroke-width="3" stroke-dasharray="10 5"/>
            <path d="M200 40 L245 180 L180 180 L215 320 L150 320 L185 460" stroke="white" stroke-width="3" stroke-dasharray="10 5"/>
...
<section id="services" class="py-24" style="background-color: var(--color-tei-white);">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 stagger-cards">
            @php
            $services = [
                ['path'=>'M17 9V7a2 2 0 00-2-2H5a2 2 0 00-2 2v6a2 2 0 002 2h2m2 4h10a2 2 0 002-2v-6a2 2 0 00-2-2H9a2 2 0 00-2 2v6a2 2 0 002 2zm7-5a2 2 0 11-4 0 2 2 0 014 0z','title'=>'Bill Payment','desc'=>'Pay your electricity bill online, via GCash, or at any authorized payment center. Fast, secure, and hassle-free.','cta'=>'Pay Now'],
                ['path'=>'M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z','title'=>'New Connection','desc'=>'Apply for a new service connection or additional meter for your home or business in a few easy steps.','cta'=>'Apply Now'],
                ['path'=>'M12 9v2m0 4h.01m-6.938 4h13.856c1.54 0 2.502-1.667 1.732-3L13.732 4c-.77-1.333-2.694-1.333-3.464 0L3.34 16c-.77 1.333.192 3 1.732 3z','title'=>'Report Outage','desc'=>'Experiencing a power interruption? Report it instantly and our crew will restore power as quickly as possible.','cta'=>'Report Now'],
                ['path'=>'M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z','title'=>'E-SOA Enrollment','desc'=>'Go paperless! Enroll in our e-Statement of Account program and receive your monthly bill via email.','cta'=>'Enroll Now'],
                ['path'=>'M16 7a4 4 0 11-8 0 4 4 0 018 0zM12 14a7 7 0 00-7 7h14a7 7 0 00-7-7z','title'=>'Senior Citizen Discount','desc'=>'Qualified senior citizens are entitled to a 5% discount on monthly electricity consumption. Apply here.','cta'=>'Learn More'],
                ['path'=>'M9 19v-6a2 2 0 00-2-2H5a2 2 0 00-2 2v6a2 2 0 002 2h2a2 2 0 002-2zm0 0V9a2 2 0 012-2h2a2 2 0 012 2v10m-6 0a2 2 0 002 2h2a2 2 0 002-2m0 0V5a2 2 0 012-2h2a2 2 0 012 2v14a2 2 0 01-2 2h-2a2 2 0 01-2-2z','title'=>'Power Rates & Advisories','desc'=>'Stay updated with current electricity rates, scheduled maintenance, and power interruption advisories.','cta'=>'View Rates'],
            ];
            @endphp

            @foreach ($services as $svc)
            <div class="card group relative bg-white rounded-2xl p-7 border cursor-pointer transition-[box-shadow,border-color] duration-300"
...
<section class="py-20 relative overflow-hidden" style="background-color: var(--color-tei-blue);">
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="grid grid-cols-2 lg:grid-cols-4 gap-8">
            @foreach ([
                ['50+',   'Years of Service',   'Est. 1962'],
                ['100K+', 'Customers Served',   'Across Tarlac Province'],
                ['15+',   'Municipalities',     'Coverage Area'],
...
<section class="py-24" style="background-color: var(--color-tei-surface);">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 stagger-cards">
            @php
            $advisories = [
                ['badge'=>'Scheduled','badgeColor'=>'#FFB81C','date'=>'June 8, 2026','time'=>'8:00 AM – 5:00 PM','title'=>'Scheduled Interruption – Zone A','area'=>'Brgy. San Sebastian, San Vicente, San Jose','reason'=>'Tree trimming and line maintenance.'],
                ['badge'=>'Scheduled','badgeColor'=>'#FFB81C','date'=>'June 10, 2026','time'=>'7:00 AM – 4:00 PM','title'=>'Line Maintenance – Tarlac City Proper','area'=>'Brgy. Sto. Cristo, San Nicolas, Sinait','reason'=>'Replacement of deteriorated distribution lines.'],
                ['badge'=>'Emergency','badgeColor'=>'#E76727','date'=>'June 5, 2026','time'=>'Ongoing','title'=>'Emergency Restoration – Concepcion','area'=>'Concepcion, La Paz District','reason'=>'Restoration underway after storm-related damage.'],
            ];
            @endphp

            @foreach ($advisories as $adv)
            <div class="card bg-white rounded-2xl overflow-hidden border transition-[box-shadow,border-color] duration-300 cursor-pointer"
                ...
                <div class="p-6">
                    ...
                    <h3 class="font-bold text-base mb-1 leading-snug" style="color: var(--color-tei-blue);">{{ $adv['title'] }}</h3>
                    ...
                    <p class="text-xs leading-relaxed mb-2" style="color: var(--color-tei-gray);">
                        <svg class="w-3.5 h-3.5 inline mr-1 -mt-0.5" fill="none" stroke="currentColor" viewBox="0 0 24 24" style="color: var(--color-tei-gray-light);">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M17.657 16.657L13.414 20.9a1.998 1.998 0 01-2.827 0l-4.244-4.243a8 8 0 1111.314 0z M15 11a3 3 0 11-6 0 3 3 0 016 0z"/>
                        </svg>
                        {{ $adv['area'] }}
                    </p>
                    <p class="text-xs leading-relaxed pb-4 border-b mb-4" style="color: var(--color-tei-gray-light); border-color: rgba(15,61,92,0.07);">{{ $adv['reason'] }}</p>
                    <a href="#" class="inline-flex items-center gap-1 text-xs font-bold" style="color: var(--color-tei-blue);">
                        View Full Advisory
...
<section class="py-20" style="background-color: var(--color-tei-white);">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="grid grid-cols-2 lg:grid-cols-4 gap-4 stagger-cards">
            @php
            $actions = [
                ['path'=>'M17 9V7a2 2 0 00-2-2H5a2 2 0 00-2 2v6a2 2 0 002 2h2m2 4h10a2 2 0 002-2v-6a2 2 0 00-2-2H9a2 2 0 00-2 2v6a2 2 0 002 2zm7-5a2 2 0 11-4 0 2 2 0 014 0z','label'=>'Pay My Bill','sub'=>'Online payment portal','bg'=>'var(--color-tei-orange)','dark'=>true],
                ['path'=>'M12 9v2m0 4h.01m-6.938 4h13.856c1.54 0 2.502-1.667 1.732-3L13.732 4c-.77-1.333-2.694-1.333-3.464 0L3.34 16c-.77 1.333.192 3 1.732 3z','label'=>'Report Outage','sub'=>'Power interruption report','bg'=>'var(--color-tei-blue)','dark'=>true],
                ['path'=>'M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z','label'=>'Apply for Meter','sub'=>'New service connection','bg'=>'var(--color-tei-surface)','dark'=>false],
                ['path'=>'M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z','label'=>'E-SOA Sign Up','sub'=>'Go paperless today','bg'=>'var(--color-tei-surface)','dark'=>false],
            ];
            @endphp
            @foreach ($actions as $act)
            <a href="#" class="card group flex flex-col items-center text-center p-6 sm:p-8 rounded-2xl border cursor-pointer transition-[box-shadow,border-color] duration-300"
               ...
               onmouseout="this.style.transform=''; this.style.boxShadow=''">
                <div class="w-14 h-14 rounded-2xl flex items-center justify-center mb-4"
                    ...
                    <svg class="w-7 h-7" fill="none"
                         stroke="{{ $act['dark'] ? 'white' : 'var(--color-tei-blue)' }}"
                         viewBox="0 0 24 24">
...
function initAnimations() {
    ...
    gsap.timeline({ defaults: { ease: 'power3.out' } })
        .from('#hero-tag',  { opacity: 0, y: 28, duration: 0.7 })
        .from('#hero-title',{ opacity: 0, y: 50, duration: 0.9 }, '-=0.4')

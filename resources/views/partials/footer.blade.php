...
<footer style="background-color: #082840;">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-16 pb-8">
        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-10 mb-14">
            ...
            <div>
                <div class="mb-4">
                    <span class="text-4xl font-black" style="font-family: var(--font-display); color: var(--color-tei-orange);">tei</span>
                    <div class="text-[10px] font-bold tracking-[0.18em] uppercase mt-0.5" style="color: rgba(255,255,255,0.45);">Tarlac Electric Inc.</div>
                </div>
                <p class="text-sm leading-relaxed mb-5" style="color: rgba(255,255,255,0.5);">
                    Providing reliable power distribution to the province of Tarlac since 1962. Committed to excellence, safety, and community.
                </p>
            ...
            {{-- Services column --}}
            <div>
                <h4 class="text-xs font-bold uppercase tracking-widest mb-5" style="color: rgba(255,255,255,0.35);">Services</h4>
                <ul class="space-y-3">
                    @foreach (['Bill Payment','New Connection','Report Outage','E-SOA Enrollment','Senior Discount','Net Metering','Power Rates'] as $item)
                    <li><a href="#" class="text-sm transition-colors duration-150"
            ...
            <div>
                ...
                <ul class="space-y-3">
                    @foreach (['About TEI','Our History','Mission & Vision','Board of Directors','Careers','CSR Programs','Procurement'] as $item)
                    <li><a href="#" class="text-sm transition-colors duration-150"
                           style="color: rgba(255,255,255,0.55);"
                           onmouseover="this.style.color='var(--color-tei-orange)'"
                           onmouseout="this.style.color='rgba(255,255,255,0.55)'">{{ $item }}</a></li>
            ...
            {{-- Contact column --}}
            <div>
                <h4 class="text-xs font-bold uppercase tracking-widest mb-5" style="color: rgba(255,255,255,0.35);">Contact Us</h4>
                <ul class="space-y-4">
                    <li class="flex items-start gap-3">
                        <svg class="w-4 h-4 mt-0.5 shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24" style="color: var(--color-tei-orange);">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M17.657 16.657L13.414 20.9a1.998 1.998 0 01-2.827 0l-4.244-4.243a8 8 0 1111.314 0z M15 11a3 3 0 11-6 0 3 3 0 016 0z"/>
                        </svg>
                        <span class="text-sm" style="color: rgba(255,255,255,0.55);">MacArthur Highway, Tarlac City, Tarlac 2300</span>
                    </li>
                    <li class="flex items-center gap-3">
                        <svg class="w-4 h-4 shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24" style="color: var(--color-tei-orange);">
                    ...
                    <li class="flex items-center gap-3">
                        ...
                        <a href="mailto:customerservice@tarlacelectric.com"
                           ...
                           style="color: rgba(255,255,255,0.55);"
                           onmouseover="this.style.color='var(--color-tei-orange)'"
                           onmouseout="this.style.color='rgba(255,255,255,0.55)'">customerservice@tarlacelectric.com</a>
                    </li>
                    <li>
                        <div class="mt-1 p-3 rounded-xl" style="background-color: rgba(231,103,39,0.12);">
                            ...
                            <p class="text-base font-black" style="color: white;">(045) 606-1834 loc. 100</p>
        ...
        <div class="border-t pt-6 flex flex-col sm:flex-row items-center justify-between gap-3"
            ...
            <div class="flex items-center gap-5">
                ...
                <a href="#" class="text-xs transition-colors duration-150"

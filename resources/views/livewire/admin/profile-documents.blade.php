              ...
              <div class="flex flex-col gap-1.5">
                <div>
                  @if ($doc->status === 'published')
                    <span
                      class="inline-flex items-center gap-1 text-xs font-semibold px-2.5 py-1 rounded-full bg-success/10 text-success">
                      <span class="size-1.5 rounded-full bg-success"></span>Published
                    </span>
                  @else
                    <span
                      class="inline-flex items-center gap-1 text-xs font-semibold px-2.5 py-1 rounded-full bg-warning/10 text-warning">
                ...
                <div>
                  @if ($doc->is_downloadable)
                    <span
                      class="inline-flex items-center gap-1 text-xs font-medium px-2.5 py-1 rounded-full bg-tei-blue/8 text-tei-blue">
    ...
    <form wire:submit.prevent="save" id="profile-doc-form" class="flex-1 overflow-y-auto px-6 py-6 space-y-5">
      ...
      <div class="flex items-center justify-between rounded-xl border border-gray-200 bg-gray-50 px-4 py-3">
        ...
        <label class="relative inline-flex items-center cursor-pointer shrink-0">
          ...
          <div
            class="w-10 h-5 rounded-full bg-gray-300 peer-checked:bg-tei-orange transition-colors duration-200
        ...
        <label for="profile-doc-pdf"
          ...
          <div class="min-w-0 flex-1">
            @if ($formFile)
              ...
              <p class="text-xs text-tei-gray-light mt-0.5">{{ number_format($formFile->getSize() / 1024, 0) }} KB ·
                click to change</p>
            @else
      ...
      <div>
        ...
        <div
          class="flex items-center rounded-xl border border-gray-200 bg-gray-50 overflow-hidden

<div>
  ...
  <div x-show="$wire.deleteTarget !== null" x-cloak style="z-index: 50;">
    ...
    <div class="fixed inset-0 bg-black/50 z-40" x-show="$wire.deleteTarget !== null"
      x-transition:enter="transition ease-out duration-150" x-transition:enter-start="opacity-0"
      x-transition:enter-end="opacity-100" x-transition:leave="transition ease-in duration-100"
      x-transition:leave-start="opacity-100" x-transition:leave-end="opacity-0" @click="$wire.cancelDelete()">
    </div>

    <div class="fixed inset-0 z-50 flex items-center justify-center p-4">
      <div class="w-full max-w-sm rounded-2xl p-6"
        style="background: white; box-shadow: 0 20px 60px rgba(15,61,92,0.18);" x-show="$wire.deleteTarget !== null"

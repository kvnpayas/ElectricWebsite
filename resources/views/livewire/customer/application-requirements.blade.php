<div>
  ...
  <x-guest-section>
    ...
    {{-- Intro card --}}
    <x-guest-intro label="Applying for Service" title="New Connection Application Requirements"
  ...
  <x-guest-section-dark>
    ...
    <div class="grid grid-cols-1 lg:grid-cols-5 gap-6 stagger-cards">
      ...
      <div class="lg:col-span-3 space-y-6">
        ...
        <div class="scroll-reveal rounded-2xl overflow-hidden border border-tei-blue/8 bg-white"
          style="box-shadow: 0 2px 12px rgba(15,61,92,0.05);">
          {{-- Panel header --}}
          <div class="flex items-center gap-3 px-5 py-4 border-b border-tei-blue/8"
            style="background: linear-gradient(135deg, rgba(15,61,92,0.04), rgba(15,61,92,0.01));">
          ...
          <div class="divide-y divide-tei-blue/5">
            @foreach (['Electrical Wiring Installation', 'Circuit Breakers', 'Service Entrance', 'Bunk House (if under construction)'] as $item)
        ...
        <div class="scroll-reveal rounded-2xl overflow-hidden border border-tei-blue/8 bg-white"
          ...
          <div class="px-5 py-3.5 border-b border-tei-blue/5">
            <div class="flex items-start gap-3 mb-2">
              ...
              <div>
                ...
                <p class="text-xs text-tei-gray-light mt-0.5">Transfer Certificate of Title, Deed of Sale, Waiver of
                  Rights, Contract of Lease, or other related documents</p>
              </div>
            </div>
            ...
            <div class="ml-7 mt-3 rounded-xl border border-tei-blue/10 bg-tei-blue/2 overflow-hidden">
              ...
              <div class="divide-y divide-tei-blue/6">
                <div class="flex items-start gap-2.5 px-3 py-2.5">
                  <svg class="w-3.5 h-3.5 shrink-0 mt-0.5 text-tei-blue/50" fill="none" stroke="currentColor"
                    viewBox="0 0 24 24">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5l7 7-7 7" />
                  </svg>
                  <p class="text-xs text-tei-gray leading-relaxed">Proof of right to occupy the premises issued by the
                    authorized individual or local government unit or entity</p>
                </div>
                <div class="flex items-start gap-2.5 px-3 py-2.5">
                  <svg class="w-3.5 h-3.5 shrink-0 mt-0.5 text-tei-blue/50" fill="none" stroke="currentColor"
                    viewBox="0 0 24 24">
                  ...
                  <p class="text-xs text-tei-gray leading-relaxed">Affidavit of Undertaking <span
                      class="text-tei-gray-light">(to be provided by TEI)</span></p>
                </div>
              </div>
            </div>
          </div>
          ...
          <div class="px-5 py-3.5">
            ...
            <div class="ml-7 flex flex-wrap gap-1.5">
              @foreach (["Driver's License", 'Passport', 'PRC License', 'SSS ID', 'GSIS ID', "Senior Citizen's ID", 'TIN ID', 'Postal ID', "COMELEC Voter's ID", "Voter's Certification", 'Original NBI Clearance'] as $id)
                <span
                  class="px-2.5 py-1 rounded-full text-[11px] font-medium bg-tei-blue/6 text-tei-blue border border-tei-blue/10">{{ $id }}</span>
              @endforeach
            </div>
          </div>
      ...
      <div class="lg:col-span-2">
        <div class="scroll-reveal rounded-2xl overflow-hidden border border-tei-orange/15 bg-white sticky top-24"
          style="box-shadow: 0 2px 12px rgba(231,103,39,0.07);">

          {{-- Panel header --}}
          <div class="flex items-center gap-3 px-5 py-4 border-b border-tei-orange/12"
            style="background: linear-gradient(135deg, rgba(231,103,39,0.05), rgba(231,103,39,0.01));">
          ...
          <div class="px-5 pt-4 pb-3 border-b border-tei-orange/8">
            <p class="text-[11px] font-bold uppercase tracking-wider text-tei-orange mb-2.5">For Duly-Authorized
              Representatives of Owners</p>
            <div class="space-y-2">
              @foreach (['Duly notarized authorization to sign contracts with TEI', 'Valid ID of Authorized Representative'] as $item)
                <div class="flex items-start gap-2.5">
                  <svg class="w-3.5 h-3.5 shrink-0 mt-0.5 text-tei-orange" fill="none" stroke="currentColor"
                    viewBox="0 0 24 24">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2.5"
                      d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z" />
                  </svg>
          ...
          <div class="px-5 pt-4 pb-3 border-b border-tei-orange/8">
            ...
            <div class="space-y-2">
              @foreach (['Undertaking from the Property Owner', 'Valid ID of Property Owner'] as $item)
                <div class="flex items-start gap-2.5">
                  <svg class="w-3.5 h-3.5 shrink-0 mt-0.5 text-tei-orange" fill="none" stroke="currentColor"
                    viewBox="0 0 24 24">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2.5"
          ...
          <div class="px-5 pt-4 pb-5">
            <p class="text-[11px] font-bold uppercase tracking-wider text-tei-orange mb-2.5">For Commercial / Business
            </p>
            <div class="space-y-2">
              @foreach (['SEC Registration / Business Registration / DTI', 'Secretary\'s Certificate authorizing the representative to sign the Meter Service Contract with TEI'] as $item)
                <div class="flex items-start gap-2.5">
                  <svg class="w-3.5 h-3.5 shrink-0 mt-0.5 text-tei-orange" fill="none" stroke="currentColor"
                    viewBox="0 0 24 24">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2.5"

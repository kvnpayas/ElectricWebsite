  ...
  <x-guest-section>
    ...
    <div
      ...
      <div class="flex gap-4 items-start">
        ...
        <div>
          <h3 class="text-base font-bold mb-2 text-tei-blue">Before You Begin</h3>
          <p class="text-sm leading-relaxed text-tei-gray">
            The application process involves coordination between TEI, the City Engineer's Office (CEO), the Bureau of
    ...
    <div class="grid grid-cols-1 sm:grid-cols-3 gap-5 stagger-cards">
      <x-card variant="primary">
        <div class="flex items-start gap-3">
          ...
          <div>
            <h4 class="text-sm font-bold mb-1 text-tei-blue">10 Steps Total</h4>
            <p class="text-xs leading-relaxed text-tei-gray">From form pickup to meter installation, the full process is
              outlined in 10 clear steps.</p>
          </div>
        </div>
      </x-card>
      ...
      <x-card variant="secondary">
        <div class="flex items-start gap-3">
          ...
          <div>
            <h4 class="text-sm font-bold mb-1 text-tei-blue">Site Visit Required</h4>
            <p class="text-xs leading-relaxed text-tei-gray">A TEI representative will visit your property to evaluate
              the site before approval.</p>
          </div>
        </div>
      </x-card>
      ...
      <x-card variant="success">
        <div class="flex items-start gap-3">
          ...
          <div>
            <h4 class="text-sm font-bold mb-1 text-tei-blue">Fees Involved</h4>
            <p class="text-xs leading-relaxed text-tei-gray">Service Connection Permit Fee, Fire Clearance, Service
              Connection Fee, and Bill Deposit are required.</p>
          </div>
        </div>
      </x-card>
    </div>

<div>
        ...
        <div>
          ...
          <div class="space-y-2 mb-3">
            <p class="text-sm leading-relaxed text-tei-gray">
              <strong class="text-tei-blue">Definition 1:</strong> Power sources connected to the distribution system or electrical system of the End-Users, that could be aggregated to meet a demand.
            </p>
            <p class="text-sm leading-relaxed text-tei-gray">
          ...
          <div class="flex items-start gap-2 rounded-xl px-4 py-3 text-sm bg-tei-orange/10 border border-tei-orange/20">
            ...
            <p class="text-xs text-tei-orange-dark">
              <strong>Legal Basis:</strong> ERC Resolution No. 11, Series of 2022 — adopted to encourage DER development and align with EPIRA, the RE Law, and other relevant regulations.
            </p>
          </div>
        </div>
      </div>
    ...
    <div class="rounded-2xl p-5 sm:p-6 bg-white border border-tei-blue/8 scroll-reveal">
      ...
      <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-2">
        @foreach ([
            ...
            'DERs intended solely to export or sell power to the Grid',
        ] as $item)
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
      ...
      <div class="grid grid-cols-1 md:grid-cols-3 gap-5 stagger-cards">
        ...
        <x-card variant="success">
          ...
          <span class="text-xs font-bold px-2 py-0.5 rounded-full bg-success/10 text-success mb-2 inline-block">ERC Resolution No. 11, 2022</span>
          <h4 class="text-sm font-bold mb-2 text-tei-blue">The DER Program</h4>
          <p class="text-xs leading-relaxed text-tei-gray">
            Encourages the development and utilization of DER while promoting energy quality, reliability, security, affordability, and sustainability. Aligned with <strong class="text-tei-blue">EPIRA (2001)</strong> and the RE Law.
          </p>
        </x-card>
        ...
        <x-card variant="primary">
          ...
          <span class="text-xs font-bold px-2 py-0.5 rounded-full bg-tei-orange/10 text-tei-orange mb-2 inline-block">Exporting DER</span>
          ...
          <p class="text-xs leading-relaxed mb-3 text-tei-gray">
            DERs utilizing <strong class="text-tei-blue">renewable energies</strong> for the End-User's total consumption AND exporting energy greater than <strong class="text-tei-blue">100 kW to 1 MW</strong>.
          </p>
          <div class="rounded-xl px-3 py-2 bg-tei-blue/10 text-xs text-tei-gray">
        ...
        <x-card variant="primary">
          ...
          <span class="text-xs font-bold px-2 py-0.5 rounded-full bg-info/10 text-info mb-2 inline-block">Non-Exporting DER</span>
          <h4 class="text-sm font-bold mb-2 text-tei-blue">Supply Only</h4>
          <p class="text-xs leading-relaxed mb-3 text-tei-gray">
            DERs that will <strong class="text-tei-blue">only supply</strong> for the End-User's consumption, regardless of generation technology and capacity.
          </p>
  ...
  <x-guest-section>
    ...
    <div class="mb-12 scroll-reveal">
      ...
      <p class="text-sm max-w-2xl text-tei-gray">Key regulatory rules governing who may export energy and the allowable capacity of DER installations.</p>
    </div>
        ...
        <div class="flex items-start gap-4">
          ...
          <div>
            ...
            <p class="text-sm leading-relaxed mb-3 text-tei-gray">
              Only DERs that <strong class="text-tei-blue">utilize renewable energies</strong> shall be allowed to export to the distribution system of the Distribution Utility (DU).
            </p>
          ...
          <div class="rounded-xl p-3 bg-tei-orange/10 mb-3">
            ...
            <div class="space-y-1">
              @foreach (['Technical Specifications of RE Facility', 'Certificates of RE Facility'] as $req)
                <div class="flex items-center gap-2 text-xs">
                  <svg class="w-3 h-3 text-tei-orange shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 13l4 4L19 7" />
                  </svg>
                  <span class="text-tei-gray">{{ $req }}</span>
                </div>
          ...
          <div class="rounded-xl p-3 bg-tei-blue/8">
            ...
            <div class="space-y-1">
              @foreach (['SEC Registration', "Secretary's Certificate", 'Valid IDs of Corporate Secretary and Authorized Representative'] as $req)
                <div class="flex items-center gap-2 text-xs">
                  <svg class="w-3 h-3 text-tei-blue shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 13l4 4L19 7" />
                  </svg>
                  <span class="text-tei-gray">{{ $req }}</span>
                </div>
          ...
          <div class="rounded-xl p-3 bg-success/10 mb-3">
            ...
            <div class="space-y-1">
              @foreach (['Renewable DER Supply Agreement', 'Management and/or Lease Contract — if applicable'] as $req)
                <div class="flex items-center gap-2 text-xs">
                  <svg class="w-3 h-3 text-success shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 13l4 4L19 7" />
                  </svg>
                  <span class="text-tei-gray">{{ $req }}</span>
                </div>
  ...
  <x-guest-section>
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 gap-5 stagger-cards mb-8">
      ...
      <x-card variant="info">
        <div class="flex items-start gap-4">
          <div class="w-10 h-10 rounded-xl flex items-center justify-center shrink-0 bg-info/10 text-info font-black text-sm">
            02
          </div>
          <div class="flex-1">
            <h4 class="text-sm font-bold mb-2 text-tei-blue">Submit to the ERC</h4>
            <p class="text-xs leading-relaxed text-tei-gray">
              Upon receipt of the <strong class="text-tei-blue">DU Certification from TEI</strong>, the applicant may proceed with the submission and processing of their DER Program application to the Energy Regulatory Commission (ERC).
            </p>
          </div>
        </div>
    ...
    <div class="rounded-2xl p-5 sm:p-6 bg-tei-surface border border-tei-blue/8 scroll-reveal">
      <div class="flex items-start gap-3">
        ...
        <div>
          ...
          <p class="text-xs leading-relaxed text-tei-gray mb-2">To learn more about the DER Program, you may reach TEI through any of the following:</p>
          <div class="flex flex-wrap gap-x-5 gap-y-1 text-xs">
            <span class="font-semibold text-tei-blue">Main Office: J. Luna corner F. Tañedo Streets, Brgy. Poblacion, Tarlac City</span>
      ...
      <div class="grid grid-cols-1 xl:grid-cols-2 gap-8 stagger-cards">
        ...
        <div>
          ...
          <div class="rounded-2xl overflow-hidden border border-tei-blue/8 bg-white">
            ...
            @php
              $feeders = [
                  ['LIPIEWP', '2,011'], ['LIPLINE', '4,400'], ['LIPSSMP', '2,874'],
                  ['LIPIWSPC', '2,569'], ['LIPSNMGL', '2,200'], ['LIPHACIENDA', '2,100'],
                  ['SANRAFARMENIA', 'Two (2) embedded plants — 7.1 MW &amp; 2 MW'],
                  ['SANRAFSMBINAUGANAN', '3,024'], ['SANRAFNORTH', '2,759'],
                  ['SANRAFNORHILLS', '1,200'], ['SANRAFSOUTH', '2,400'],
                  ['MALGETHA', '1,253'], ['MALJOSE', '2,016'], ['MALGLOBE', '2,306'],
                  ['MALAMU', '2,978'], ['PANGHIWAY', '3,400'],
                  ['PANGSCRUZ', 'One (1) embedded plant — 5.5 MW'],
                  ['PANGNASI', 'Loads → San Vicente FDR1'],
                  ['PANGSANVIC', 'Loads → San Vicente FDR2'],
                  ['PANGPOB', '3,708'], ['PANGSSV', 'FOR N-1'],
                  ['TPCFDR 1', '2,700'], ['TPCFDR 2', '2,700'],
                  ['San Vicente FDR1', '2,500'], ['San Vicente FDR2', '1,100'],
                  ['San Vicente FDR3', '2,400'], ['San Vicente FDR4', '1,700'],
                  ['San Vicente FDR5', '2,500'],
              ];
            @endphp
            @foreach ($feeders as [$feeder, $cap])
              @php $isNote = !is_numeric(str_replace([',', ' '], '', $cap)); @endphp
              <div class="grid grid-cols-2 px-5 py-3 border-b border-tei-blue/6 last:border-0 {{ $loop->even ? 'bg-tei-surface' : 'bg-white' }}">
                <p class="text-xs font-semibold text-tei-blue">{{ $feeder }}</p>
                <p class="text-xs text-right {{ $isNote ? 'text-tei-gray-light italic' : 'font-black text-tei-orange' }}">{!! $cap !!}</p>
              </div>
            @endforeach
          </div>
        </div>
        ...
        <div>
          ...
          <div class="rounded-2xl overflow-hidden border border-tei-blue/8 bg-white">
            ...
            @foreach ([
                ['LIP Substation', '16,154'],
                ['San Rafael Substation', '9,383'],
                ['Maliwalo Substation', '8,554'],
                ['Panganiban Substation', '7,108'],
                ['TPC Substation', '5,400'],
                ['San Vicente Substation', '10,200'],
            ] as [$sub, $cap])
              <div class="grid grid-cols-2 px-5 py-4 border-b border-tei-blue/6 last:border-0 {{ $loop->even ? 'bg-tei-surface' : 'bg-white' }}">

<div x-data="{ tab: 'generation' }">
  ...
  <x-guest-section>
    ...
    <div class="rounded-2xl p-6 sm:p-8 mb-5 scroll-reveal"
      ...
      <div class="flex gap-4 items-start">
        ...
        <div>
          <h3 class="text-base font-bold mb-2" style="color: var(--color-tei-blue);">About Your Statement of Account
            (SOA)</h3>
    ...
    <div id="panel-generation" x-show="tab === 'generation'" x-transition:enter="transition ease-out duration-200"
      ...
      <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-5 stagger-cards">
          ...
          {{-- Generation Charge --}}
          <div
            class="card group bg-white rounded-2xl border overflow-hidden transition-[box-shadow,border-color,transform] duration-300"
              ...
              <div class="flex items-start gap-4">
                ...
                <div>
                  ...
                  <p class="text-sm leading-relaxed" style="color: var(--color-tei-gray);">
                    The generation charge takes up the <strong style="color: var(--color-tei-blue);">biggest percentage
                      of your SOA</strong>.
          ...
          <div
            ...
            <div class="p-6">
              <div class="flex items-start gap-4">
                ...
                <div>
                  <h4 class="text-base font-bold mb-1.5" style="color: var(--color-tei-blue);">DAA (GRAM &amp; ICERA)
                  </h4>
                  <p class="text-sm leading-relaxed mb-3" style="color: var(--color-tei-gray);">
                  ...
                  <div class="space-y-2">
                    <div class="rounded-xl px-3 py-2 text-xs" style="background: rgba(15,61,92,0.04);">
                      ...
                      <span style="color: var(--color-tei-gray);"> — Generation Rate Adjustment Mechanism. Covers
                    ...
                    <div class="rounded-xl px-3 py-2 text-xs" style="background: rgba(15,61,92,0.04);">
                      ...
                      <span style="color: var(--color-tei-gray);"> — Incremental Currency Exchange Rate Adjustment.
          ...
          <div
            ...
            <div class="p-6">
              <div class="flex items-start gap-4">
                ...
                <div>
                  <h4 class="text-base font-bold mb-1.5" style="color: var(--color-tei-blue);">Transmission Charge
                  </h4>
                  <p class="text-sm leading-relaxed" style="color: var(--color-tei-gray);">
                    Paid to the <strong style="color: var(--color-tei-blue);">National Grid Corporation of the
              ...
              <div class="flex items-start gap-4">
                ...
                <div>
                  ...
                  <p class="text-sm leading-relaxed" style="color: var(--color-tei-gray);">
                    ...
                    <strong style="color: var(--color-tei-blue);">unavoidable</strong> due to the nature of energy
                    being transported.
  ...
  ──────────────────────────────────────────── --}}
    <div id="panel-distribution" x-show="tab === 'distribution'"
      ...
      x-transition:enter-end="opacity-100 translate-y-0" class="py-20"
      style="background-color: var(--color-tei-surface);">
      <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
      ...
      <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="mb-12 scroll-reveal">
          ...
          <p class="text-sm max-w-2xl" style="color: var(--color-tei-gray);">
            ...
            Up to <strong style="color: var(--color-tei-blue);">5% discount</strong> is granted, subsidized by other
            TEI customers.
          </p>
        </div>
            ...
            <div class="p-6">
              <div class="flex items-start gap-4">
                ...
                <div>
                  ...
                  <p class="text-sm leading-relaxed mb-3" style="color: var(--color-tei-gray);">
                    This subsidized rate is <strong style="color: var(--color-tei-blue);">automatically given</strong>
                    to
          ...
          <div
            ...
            <div class="p-6">
              <div class="flex items-start gap-4">
                ...
                <div>
                  <div class="flex items-center gap-2 mb-1.5 flex-wrap">
                    <h4 class="text-base font-bold" style="color: var(--color-tei-blue);">Subsidy on Senior Citizen
                    </h4>
                    <span class="text-xs font-bold px-2 py-0.5 rounded-full"
          ...
          <div
            ...
            <div class="p-6">
              <div class="flex items-start gap-4">
                ...
                <div>
                  <h4 class="text-base font-bold mb-1.5" style="color: var(--color-tei-blue);">Franchise Tax – Local
                  </h4>
                  <p class="text-sm leading-relaxed" style="color: var(--color-tei-gray);">
                    Following the conditions of the <strong style="color: var(--color-tei-blue);">Local Government Code
          ...
          <div
            ...
            <div class="p-6">
              <div class="flex items-start gap-4">
                ...
                <div>
                  <h4 class="text-base font-bold mb-1.5" style="color: var(--color-tei-blue);">Value Added Tax (VAT)
                  </h4>
                  <p class="text-sm leading-relaxed" style="color: var(--color-tei-gray);">
                    This sales tax is added to the price of services obtained from TEI. It covers
                    <strong style="color: var(--color-tei-blue);">all services provided by TEI</strong> — from
                  ...
                  <div class="space-y-2">
                    @foreach ([['Missionary Electrification', 'Funds the energization of remote locations not easily accessible or connected to the TEI distribution system.'], ['Environmental Charge', 'Used for watershed rehabilitation and management of the National Power Corporation (NPC). Set at PHP 0.0025/kWh.'], ['Stranded Contract Cost', 'Excess of contracted cost of electricity under qualified IPP contracts of NPC over the actual selling price of contracted electric output.'], ['Stranded Debt', 'The amount that has not yet been settled from the sales and privatization of state power assets.']] as [$name, $detail])
                      <div class="rounded-xl px-3 py-2.5"
                        style="background: rgba(15,61,92,0.03); border: 1px solid rgba(15,61,92,0.05);">
                        <p class="text-xs font-bold mb-0.5" style="color: var(--color-tei-blue);">{{ $name }}
                        </p>
                        <p class="text-xs leading-relaxed" style="color: var(--color-tei-gray);">{{ $detail }}
                        </p>
                      </div>
                    @endforeach
                  </div>

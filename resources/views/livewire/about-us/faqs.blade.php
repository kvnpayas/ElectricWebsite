<div>
  ...
  <x-guest-section-dark>
    ...
    <div class="mb-12 scroll-reveal">
      <x-section-heading title="New Connection Application" variant="secondary" align="left" />
    ...
    {{-- ── Bill Deposit ─────────────────────────────────── --}}
    <div class="mb-12 scroll-reveal">
      <x-section-heading title="Bill Deposit" variant="secondary" align="left" />
      <div class="flex flex-col gap-3">
    ...
    {{-- ── Billing & Payment ────────────────────────────── --}}
    <div class="mb-12 scroll-reveal">
      <x-section-heading title="Billing & Payment" variant="secondary" align="left" />
      <div class="flex flex-col gap-3">
    ...
    {{-- ── Complaints ───────────────────────────────────── --}}
    <div class="mb-12 scroll-reveal">
      <x-section-heading title="Complaints" variant="secondary" align="left" />
      <div class="flex flex-col gap-3">
    ...
    {{-- ── Pilferage ────────────────────────────────────── --}}
    <div class="mb-12 scroll-reveal">
      <x-section-heading title="Pilferage" variant="secondary" align="left" />
      <div class="flex flex-col gap-3">
    ...
    <div class="scroll-reveal">
      <x-section-heading title="Others" variant="secondary" align="left" />
      <div class="flex flex-col gap-3">

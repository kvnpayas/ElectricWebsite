<div>
  ...
  <x-guest-section>
    ...
    <div class="scroll-reveal mb-12">
      <p class="text-[11px] font-bold text-tei-orange uppercase tracking-[0.2em] mb-3">Competitive Selection Process</p>
      <div class="flex flex-col lg:flex-row gap-10 lg:gap-16 items-start">

        <div class="flex-1 space-y-4 text-sm leading-relaxed text-tei-gray">
          <p>The conduct of CSP is governed by DOE Department Circular No. DC2023-06-0021 entitled <em>"Prescribing the
              Policy of the Mandatory Conduct of the Competitive Selection Process by the Distribution Utilities for the
              Procurement of Power Supply for their Captive Market"</em> and ERC Resolution No. 16, Series of 2023
            entitled <em>"Implementing Guidelines for the Procurement, Execution, and Evaluation of Power Supply
              Agreements Entered into by Distribution Utilities for the Supply of Electricity to their Captive
              Market"</em>, which took effect on 19 July 2023 and 23 October 2023, respectively.</p>
          <p>This site contains the latest Power Supply Procurement Plan (PSPP) of TEI and information on ongoing bids.
          </p>
        </div>

        <div class="w-full lg:w-80 shrink-0 border-l-[3px] border-tei-orange pl-6 self-stretch">
          <p class="text-[10px] font-black text-tei-orange uppercase tracking-widest mb-2">Good to know</p>
          <p class="text-sm font-bold text-tei-blue mb-1.5">For Inquiries</p>
          <p class="text-xs leading-relaxed text-tei-gray">Kindly email the BAC-Secretariat of TEI's Bids and Awards
            Committee for power supply agreements at
            <a href="mailto:bac-secretariat@teiph.com"
              class="text-tei-orange font-semibold hover:underline">bac-secretariat@teiph.com</a>.
          </p>
        </div>
  ...
  <x-guest-section-dark>
    ...
    <x-section-heading
      ...
      heading="Power Supply Procurement Bids"
    ...
    <div class="space-y-8">
      ...
      <div class="bg-white rounded-2xl border border-tei-blue/8 shadow-sm overflow-hidden scroll-reveal">
        ...
        <div class="px-6 pt-6 pb-5 border-b border-tei-blue/6">
          <div class="flex flex-wrap items-center gap-2 mb-3">
            <span class="font-mono text-xs font-bold text-tei-blue tracking-wide">TEI-CSP-OT-2025-001</span>
        ...
        <div class="px-6 py-6 space-y-8">
          ...
          <div class="rounded-xl overflow-hidden border border-tei-blue/8">
            ...
            {{-- Contract Capacity — inline with escalation table --}}
            <div class="flex gap-4 px-4 py-4 border-b border-tei-blue/6 bg-white">
              ...
              <div class="flex-1">
                <p class="text-xs text-tei-gray mb-3">10MW Supply from 26 December 2026 to 25 December 2041 with
                  escalation in contracted capacity as presented below.</p>
                <div class="rounded-xl overflow-hidden border border-tei-blue/8">
                  ...
                  @foreach ([['26-Dec-26', '25-Dec-27', '10'], ['26-Dec-27', '25-Dec-28', '15'], ['26-Dec-28', '25-Dec-31', '20'], ['26-Dec-31', '25-Dec-41', '25']] as $r)
                    <div
                      class="grid grid-cols-3 px-4 py-2.5 border-t border-tei-blue/6 {{ $loop->even ? 'bg-tei-surface' : 'bg-white' }}">
                      <p class="text-xs font-semibold text-tei-blue-dark">{{ $r[0] }}</p>
                      <p class="text-xs text-tei-gray">{{ $r[1] }}</p>
                      <p class="text-xs font-bold text-tei-blue text-center">{{ $r[2] }}</p>
                    </div>
                  @endforeach
                </div>
              </div>
            ...
            @foreach ([['Contract Term', '15 Years'], ['Date of Publication', '02 September 2025'], ['1st Pre-bid Conference', '19 September 2025'], ['2nd Pre-bid Conference', '26 September 2025'], ['Expression of Interest Deadline', '23 September 2025'], ['CSP Bid Opening', '21 November 2025']] as [$label, $value])
              <div
          ...
          <div>
            ...
            <div class="rounded-xl overflow-hidden border border-tei-blue/8">
              @foreach ([['26 Dec 2025', 'Notice of Award'], ['06 Jan 2026', 'Erratum: Notice of Award']] as [$date, $label])
                <div
                  ...
                  <a href="#"
                    class="text-xs font-semibold text-tei-orange hover:underline flex-1">{{ $label }}</a>
            ...
            <div class="rounded-xl overflow-hidden border border-tei-blue/8">
              @foreach ([
                ...
                <a href="#"
                  ...
                  <svg class="w-4 h-4 text-tei-orange shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                      d="M12 10v6m0 0l-3-3m3 3l3-3m2 8H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z" />
                  </svg>
                  <span class="text-xs font-medium text-tei-blue flex-1 group-hover:text-tei-orange transition-colors duration-150">{{ $doc }}</span>
                  <svg class="w-3.5 h-3.5 text-tei-gray-light shrink-0 group-hover:text-tei-orange transition-colors duration-150" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <div class="rounded-xl overflow-hidden border border-tei-blue/8">
              @foreach (['No. 01', 'No. 02', 'No. 03', 'No. 04', 'No. 05', 'No. 06'] as $bb)
                <a href="#"
                  ...
                  <span class="text-xs font-medium text-tei-blue flex-1 group-hover:text-tei-orange transition-colors duration-150">Bid Bulletin {{ $bb }}</span>
                  <svg class="w-3.5 h-3.5 text-tei-gray-light shrink-0 group-hover:text-tei-orange transition-colors duration-150" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5l7 7-7 7" />
                  </svg>
                </a>
      ...
      <div class="bg-white rounded-2xl border border-tei-blue/8 shadow-sm overflow-hidden scroll-reveal">
        ...
        <div class="px-6 pt-6 pb-5 border-b border-tei-blue/6">
          <div class="flex flex-wrap items-center gap-2 mb-3">
            <span class="font-mono text-xs font-bold text-tei-blue tracking-wide">TEI-CSP-RE-2025-001</span>
        ...
        <div class="px-6 py-6 space-y-8">
          ...
          {{-- Contract details --}}
          <div class="rounded-xl overflow-hidden border border-tei-blue/8">
            @foreach ([['Contract Capacity', '10,000 kW'], ['Contract Term', '10 Years'], ['Date of Publication', '28 April 2025'], ['Pre-bid Conference', '09 May 2025'], ['Expression of Interest Deadline', '15 May 2025'], ['Bid Submission Deadline', '24 June 2025']] as [$label, $value])
              <div
                class="flex gap-4 px-4 py-3 border-b border-tei-blue/6 last:border-0 {{ $loop->odd ? 'bg-tei-surface' : 'bg-white' }}">
                <span class="text-xs font-bold text-tei-blue-dark shrink-0 w-52">{{ $label }}</span>
                <span class="text-xs text-tei-gray">{{ $value }}</span>
